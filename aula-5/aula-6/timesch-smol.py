...
#labels:
    #cosmetic
sclbl=tk.Label(root, text="Captura Única", bg="#4086f7", font="Aptos 14 bold", fg="white", width=25, height=1)
sclbl.pack()
loplbl=tk.Label(root, text="Captura Repetida", bg="#4086f7", font="Aptos 14 bold", fg="white", width=25, height=1)
loplbl.pack(pady=170)
    #useful
reslbl=tk.Label(root, text="Resolução:", font="Aptos 10 bold", bg="white")
reslbl.place(x=10, y=80)
lplbl=tk.Label(root, text="Repetir:", font="Aptos 10 bold", bg="white")
lplbl.place(x=10, y=270)
intlbl=tk.Label(root, text="Intervalo:", font="Aptos 10 bold", bg="white")
intlbl.place(x=10, y=320)
multiplication=tk.Label(root, text="*", font="Aptos 18 bold", bg="white", fg="#306bc9")
multiplication.place(x=190, y=80)

#entries:
    #single screenshot
resent=tk.Entry(root, font="Aptos 9", highlightthickness=2, bd=0, highlightbackground="black", width=6)
resent.place(x=125, y=82)
resent2=tk.Entry(root, font="Aptos 9", highlightthickness=2, bd=0, highlightbackground="black", width=6)
resent2.place(x=210, y=82)
    #looped screenshot
repent=tk.Entry(root, font="Aptos 9", highlightthickness=2, bd=0, highlightbackground="black", width=6)
repent.place(x=140, y=272)
intent=tk.Entry(root, font="Aptos 9", highlightthickness=2, bd=0, highlightbackground="black", width=6)
intent.place(x=140, y=322)

#buttons
scbtn=tk.Button(root, font="Aptos 8 bold", bd=3, bg="#0e64ed", fg="white", width=11, text="Capturar", command=screen)
scbtn.place(x=110, y=140)
lopbtn=tk.Button(root, font="Aptos 8 bold", bd=3, bg="#0e64ed", fg="white", width=11, text="Começar", command=lambda: screenm(int(repent.get())))
